(function ($) {
  ...
  function primary_nav() {
    ...
    if ($(window).width() < 960) {
      ...
      ).append('<span class="genericon expand" /><img src="../wp-content/themes/illustratr/js/caret-down-solid.svg" width="16" height="16"/>');
      $(".main-navigation ul .genericon").click(function (event) {
        event.preventDefault();
		if($(this).hasClass("expand")) {
			$(this).children("img").remove();
			$(this).append('<img src="../wp-content/themes/illustratr/js/caret-up-solid.svg" width="16" height="16"/>');
			$(this).toggleClass("expand").toggleClass("collapse");
		} else if($(this).hasClass("collapse")) {
			$(this).children("img").remove();
			$(this).append('<img src="../wp-content/themes/illustratr/js/caret-down-solid.svg" width="16" height="16"/>');
			$(this).toggleClass("expand").toggleClass("collapse");
		}
        //$(this).toggleClass("expand").toggleClass("collapse");
  ...
  function image_post_format() {
    $(".hentry.format-image img, .portfolio-entry .entry-content img").each(
      function () {
        var img = $(this),
        ...
        if (img_width >= 1100) {
          ...
          if ($.trim($(this).parents("p").text()) != "") {
            $(this)
              ...
              .contents()
              .filter("a, img")
              .wrap('<span class="image-big-wrapper" />');
  ...
  function content() {
    $(
      ".page-content, .hentry:not(.portfolio-entry) .entry-content, .entry-summary, .entry-sharedaddy, .sharedaddy"
    ).each(function () {
      if (
  ...
  function calc() {
    $(
      ".entry-thumbnail, .entry-gallery, .entry-media, .hentry.format-video > .video-wrapper, .caption-big"
    ).each(function () {
      if ($(window).width() < 768) {
  ...
  function sharedaddy() {
    $(
      ".hentry.format-aside .entry-content > .sharedaddy, .hentry.format-quote .entry-content > .sharedaddy, .hentry.format-status .entry-content > .sharedaddy"
    ).each(function () {
